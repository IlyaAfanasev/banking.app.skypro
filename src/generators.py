...
def filter_by_currency(transactions: list[dict], currensy_code: str) -> Iterable:
    ...
    return (x for x in transactions if x["operationAmount"]["currency"]["code"] == currensy_code)
